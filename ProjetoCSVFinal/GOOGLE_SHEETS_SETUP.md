...
```js
const GOOGLE_SHEETS_WEBAPP_URL = "https://script.google.com/macros/s/SUA_URL_AQUI/exec";
```
...
5. Cole a URL copiada na linha:
   ```js
   const DISCORD_WEBHOOK_URL = "COLE_AQUI_A_URL_DO_WEBHOOK";
   ```
...
2. Coloque o e-mail (ou e-mails, separados por vírgula) que devem receber o aviso:
   ```js
   const NOTIFICATION_EMAILS = "equipe@escritorio.com.br";
   ```
